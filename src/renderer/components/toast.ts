import { IActionProps, IconName, ILinkProps, Intent, IToaster, Position, Toaster } from '@blueprintjs/core';

let MessageToaster: IToaster | null = null;

export type MessageType = 'info' | 'success' | 'notification' | 'warning' | 'error';
...
export function showToast(message: MessageState) {
    ...
    MessageToaster.show({message: message.text, icon, intent, action, timeout});
}
